...
from pipeline.specs.image_classification_pipeline import image_classification_custom_objects, wrap_loaded_image_classification_model
...
class ImageClassificationPageAdapter:
    def __init__(self, pipeline):
        self.pipeline = pipeline
        self.sample_dir = resolve_path("data/dev/image_classification/images")
